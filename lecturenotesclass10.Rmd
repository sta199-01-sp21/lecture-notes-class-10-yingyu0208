...
***Very close or the same to the probabilities you would expect that we calculated earlier; law of large numbers (more trials = closer to true percentage)***
...
***Not that likely, slightly less than 50%***
...
***Absolute value has higher probability***
